          ...
          <table class="event-table">
            ...
            <tbody>
              ${this.events.map(event => html`
                <tr>
                  <admin-event-management-event
                    .event=${event}
                    @showPopUpEvent=${() => this.handleShowUpdatePopup(event)}
                    @showPopUpEventSuppression=${() => this.handleShowConfirmationPopup(event)}
                  ></admin-event-management-event>
                </tr>
              `)}
            </tbody>
